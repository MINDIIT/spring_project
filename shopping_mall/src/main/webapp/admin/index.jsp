    ...
    <form id="frm_login">
        <div class="admin_login">
            ...
            <span>
                <div class="left_div">
                <ul>
                <li><input type="text" class="input_text1" id="admin_id" name="admin_id" placeholder="관리자 아이디를 입력하세요"></li>
                <li><input type="password" class="input_text1" name="admin_pass" placeholder="관리자 패스워드를 입력하세요"></li>
                </ul>
                </div>
